...
@kotlin.Deprecated(message = "Please use sortWith instead", replaceWith = kotlin.ReplaceWith(expression = "this.sortWith(Comparator(comparison))", imports = {}))
...
@kotlin.Deprecated(message = "Please use other sorting functions from the Standard Library")
@kotlin.DeprecatedSinceKotlin(warningSince = "1.6")
@kotlin.internal.InlineOnly
