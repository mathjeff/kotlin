...
@kotlin.Deprecated(message = "Please use String.plus() instead", replaceWith = kotlin.ReplaceWith(expression = "this + str", imports = {}))
...
@kotlin.Deprecated(message = "Please use Regex.findAll() instead")
@kotlin.DeprecatedSinceKotlin(warningSince = "1.6")
@kotlin.internal.InlineOnly
...
@kotlin.Deprecated(message = "Please use Regex.matches() instead", replaceWith = kotlin.ReplaceWith(expression = "regex.toRegex().matches(this)", imports = {}))
@kotlin.DeprecatedSinceKotlin(warningSince = "1.6")
