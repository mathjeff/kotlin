...
internal class KonanIrLinker(
    ...
    override fun createModuleDeserializer(moduleDescriptor: ModuleDescriptor, klib: KotlinLibrary?, strategy: DeserializationStrategy) =
            when {
                ...
                cachedLibraries.isLibraryCached(klib) -> {
                    ...
                    KonanModuleDeserializer(moduleDescriptor, klib, strategy).also {
