...
object FirConventionFunctionCallChecker : FirFunctionCallChecker() {
    override fun check(expression: FirFunctionCall, context: CheckerContext, reporter: DiagnosticReporter) {
        ...
        reportPropertyAsOperator(expression, expression.dispatchReceiver, context, reporter)
        reportPropertyAsOperator(expression, expression.extensionReceiver, context, reporter)
    ...
    private fun reportPropertyAsOperator(
